                ...
                <div className="footer-grid">
                    ...
                    <div className="footer-column">
                        ...
                        <div className="footer-socials">
                            ...
                            <a href="https://www.instagram.com/naphtaliinitiative_/"><Instagram className="footer-icon" /></a>
                    ...
                    <div className="footer-column">
                        ...
                        <ul className="footer-contact">
                            ...
                            <li><Phone className="footer-contact-icon" /><span>+234 817 846 5958</span></li>
                        </ul>
                    </div>
